...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosDetallesConsulta> datosDetallesJacksonTester;
    ...
    @Test
    @DisplayName("Deberia devolver http 200 cuando la request resiba un json valido")
    @WithMockUser
    void reservar_escenario2() throws Exception{
        var fecha = LocalDateTime.now().plusHours(1);
        var especialidad = Especialidad.CARDIOLOGIA;
        var datosDetalles = new DatosDetallesConsulta(null, 2L, 5L, fecha);
        when(reservaDeConsultas.reservar(any())).thenReturn(datosDetalles);
        ...
        var jsonEsperado = datosDetallesJacksonTester.write(datosDetalles).getJson();
